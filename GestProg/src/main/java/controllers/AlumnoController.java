...
public class AlumnoController {
    ...
    public AlumnoController(IAlumnoRepository alumnoRepository, IStorageAlumno alumnoStorage) {
    ...
    public Alumno crearAlumno(Alumno alumno) throws AlumnoException {
     ...
     */
    public Alumno getAlumnoByNombre(String nombre) throws AlumnoException {
     ...
     * @throws AlumnoException si no existe el pais
     */
    public Alumno getAlumnoById(int id) throws AlumnoException {
     ...
     */
    public Alumno deleteAlumno(String nombre) throws AlumnoException {
        var alumno = alumnoRepository.findByNombre(nombre);
        if (alumno != null) {
